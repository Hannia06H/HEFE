...
<div class="container mt-4">
    <h4 class="text-center">Editar Proveedores</h4>
</div>

<section id="formulario">
    <form method="post" action="{{ route('actualizar', ['id' => $proveedor->id]) }}">
        @csrf
        @method("put")
        <input name="nombre" type="text" placeholder="Nombre" value="{{ $proveedor->nombre }}">
        <input name="responsable" type="text" placeholder="Responsable" value="{{ $proveedor->responsable }}">
        <input name="contacto" type="text" placeholder="Contacto" value="{{ $proveedor->contacto }}">
        <input name="direccion" type="text" placeholder="Direccion" value="{{ $proveedor->direccion }}">
